...
mtc_error imapcram_clicked(gpointer pdata)
{
	mtc_account *paccount= (mtc_account *)pdata;
...
mtc_error imapcram_remove(gpointer pdata, guint *naccounts)
{
	mtc_account *paccount= (mtc_account *)pdata;
...
gpointer imapcram_get_config(gpointer pdata)
{
	mtc_account *paccount= (mtc_account *)pdata;
...
mtc_error imapcram_put_config(gpointer pdata)
{
	mtc_account *paccount= (mtc_account *)pdata;

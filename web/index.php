...
function show_page2()
{
	...
	<b>Features:</b><br />
	<ul>
	<li>POP3 and IMAP4 checking.</li>
	<li>APOP, CRAM-MD5 and SSL/TLS authentication (requires OpenSSL).</li>
	<li>Customisable mail filters.</li>
	...
	<li>Ability to filter mails by sender or subject.</li>
	<li>Plugin architecture allowing additional network plugins to be used.</li>
	<li>Ability to run a command (e.g play a sound) when new mail arrives.</li>
	<li>Localisation support with gettext (currently no translations available).</li>
	</ul><br /><br />
	<b>Requirements:</b><br />
	<ul>
	<li><a href=\"http://www.gtk.org\">Gtk 2.4 or above</a></li>
	<li><a href=\"http://www.openssl.org\">OpenSSL</a> (Optional but recommended)</li>
	<li>A standards compliant panel such as <a href=\"http://fbpanel.sf.net\">fbpanel</a></li>
	</ul><br /><br />
	<b>Contact:</b>
...
function show_page3()
{
	echo "
  	<b>Next Release</b><br />
	<ul>
    <li>Improve plugin API to allow custom plugin options. <span class=\"text_highlight\">(to do)</span></li>
    <li>Rewrite error reporting. <span class=\"text_highlight\">(to do)</span></li>
    <li>Port to Win32 using GtkStatusIcon, and winsock routines. <span class=\"text_highlight\">(in progress)</span></li>
	</ul><br /><br />
	";
}
...
function show_page5()
{
	...
	You can also checkout the latest development source from the <a href=\"http://mailtc.svn.sourceforge.net/viewcvs.cgi/mailtc/\">SVN repository here</a>, or alternatively use the command: <p><span class=\"text_highlight\">svn co https://mailtc.svn.sourceforge.net/svnroot/mailtc mailtc</span></p>
	";
}
...
{ 
	...
	<br /><br /><span class=\"text_highlight\">tar -zxvf mailtc-xx.tar.gz</span><br /><br />
	...
	To compile without OpenSSL (this means that your passwords will be installed in clear text, and you will only get the basic POP3 and IMAP4 plugins installed) type:<br /><br />
...
function show_page7()
{
	...
	The example plugin can be downloaded from <a href=\"http://downloads.sourceforge.net/mailtc/mtc_dummyplug-1.3.7.tar.gz?download\">here</a>.  This plugin does not actually contain any network code, but demonstrates how to implement the relevant plugin routines for use with mailtc.
	";
}
